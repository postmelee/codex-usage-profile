...
const SAMPLE_USAGE_SNAPSHOT_V2 = Object.freeze({
  schemaVersion: 2,
...
export async function analyzeUsage(options = {}) {
  return createSampleUsageSnapshotV2({
...
export function createSampleUsageSnapshotV2(overrides = {}) {
  return mergeSnapshot(structuredClone(SAMPLE_USAGE_SNAPSHOT_V2), overrides);
}

function normalizeCapturedAt(value) {
  if (value === undefined || value === null) {
    return SAMPLE_USAGE_SNAPSHOT_V2.capturedAt;
  }
